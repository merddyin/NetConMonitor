# Run this in an administrative PowerShell prompt to install the NetConMonitor PowerShell module:
#
# iex (New-Object Net.WebClient).DownloadString("https://github.com/merddyin/NetConMonitor/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'NetConMonitor'
$DownloadURL = 'https://github.com/merddyin/NetConMonitor/raw/master/release/NetConMonitor-current.zip'
