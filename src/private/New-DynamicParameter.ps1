...
.PARAMETER CreateVariables
    Indicates that a variable for the item should be created

.PARAMETER BoundParameters
    Used to provide a dictionary with any combination of parameters and values, rather than setting individually
